...
|- **Game Master Prompt Rewrite**: Prompt sekarang menggunakan embedded labels (USIA, LOKASI, STAT, NPC, QUEST, dll) yang diselipkan di narasi, bukan JSON output — aligned dengan kode parser yang sudah ada.
